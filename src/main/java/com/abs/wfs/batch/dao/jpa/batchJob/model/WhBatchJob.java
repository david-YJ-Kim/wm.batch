...
@Getter
@Setter
@Entity(name = "WH_BATCH_JOB")
public class WhBatchJob {

    @Id
    @GenericGenerator(name = "WH_BATCH_JOB_SEQ_GENERATOR", strategy = "com.abs.wfs.batch.util.ObjIdGenerator")
    @GeneratedValue(generator = "WH_BATCH_JOB_SEQ_GENERATOR")
    @Column(name = "OBJ_ID")
    ...
    @Builder
    public WhBatchJob(String objId, String refObjId, String siteId, String jobId, BatchJobType jobTyp, String jobDesc, String invokeUnit, String invokeVal, Long maxOccur, Long crntOccur, String evntNm, String prevEvntNm, String cstmEvntNm, String prevCstmEvntNm, UseStatCd useStatCd, String rsnCd, String trnsCm, Timestamp jobStartDt, String crtUserId, Timestamp crtDt, String mdfyUserId, Timestamp mdfyDt, Timestamp fnlEvntDt, String tid) {
        this.objId = objId;
