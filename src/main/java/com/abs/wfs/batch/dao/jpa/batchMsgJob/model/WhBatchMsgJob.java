...
@Getter
@Setter
@Entity(name = "WH_BATCH_MSG_JOB")
public class WhBatchMsgJob {


    @Id
    @GenericGenerator(name = "WH_BATCH_MSG_JOB_SEQ_GENERATOR", strategy = "com.abs.wfs.batch.util.ObjIdGenerator")
    @GeneratedValue(generator = "WH_BATCH_MSG_JOB_SEQ_GENERATOR")
    @Column(name = "OBJ_ID")
